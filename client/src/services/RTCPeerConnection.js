...
export function connectToNewUserUsingPeer(
  stream,
  peer,
  peerId,
  stateUpdaterCB
  ...
  call.on("stream", (remoteStream) => {
    console.log(remoteStream, "connectToNewUserUsingPeer");
    stateUpdaterCB({
      // meetingId,
      // peerId,
      stream: remoteStream
...
export function listenAndAnswerIncomingCall(stream, peer, stateUpdaterCB) {
  ...
  peer.on("call", (call) => {
    ...
    debugger;
    call.on("stream", (remoteStream) => {
      console.log(remoteStream, stream, "listenAndAnswerIncomingCall");
      stateUpdaterCB({
        stream: remoteStream
      });
      // console.log("remoteStream", remoteStream);
